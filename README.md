...
<p>
Download the osTicket installation files reference from the Prerequisities section above. Once downloaded, unzip the files. Inside the folder, you should see the files as shown in the above image.
</p>
<br />
